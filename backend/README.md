...
To install dependencies navigate to the `/backend` directory and run:
...
Currently this Application runs only on local server.
To run the server from within the `./src` directory first ensure you are working using your created virtual environment.
